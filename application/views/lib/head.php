<?php $this->session->set_userdata('KCFINDER', array('disabled' => false));  ?><!DOCTYPE html>
<html lang="en">
<head>
        <meta charset="utf-8">
       ...
       <!--- <link href="assets/plugins/jquery-ui-1.12.1/jquery-ui.min.css" rel="stylesheet" type="text/css"/>-->
		...
		<style>
		.required{	font-size:18px;	color:red;	font-weight:900;	padding-left:5px;}.record{		color:red;	text-align:center;}
		.loader_custome{
		display:none;
	    background: rgba(0, 0, 0,0.5) url(assets/img/loder.gif);		
	    width: 100%;
		position: absolute;
		z-index: 9999;
		height: 100%;
