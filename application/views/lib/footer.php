 <footer class="main-footer">
                ...
                <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="javascript:void(0)">IT TECH Software Solutions </a>.</strong> All rights reserved. <i class="fa fa-user color-green"></i>
            </footer>
        </div>
        <!-- ./wrapper -->
        <!-- Start Core Plugins
        ...
        <script>
			...
			/*	
                setTimeout(function () {
                    ...
                    toastr.success('Developed By ask onlline solution ', 'Welcome to Car Rental');
