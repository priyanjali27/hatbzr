...
class Checkout_model extends CI_Model{
	...
	{
		$this->db->insert($this->pro->prifix.$this->pro->useraddress,$data);
		return $this->db->insert_id();
	...
	{
		$this->db->insert($this->pro->prifix.$this->pro->bookingdetail,$data);
		return $this->db->insert_id();
	...
	/*=======
	 function  Email templete
	 parameter :-- email		 
	 return type templete  
	 date 03/09/2017
	 written by pravin 
	=====*/
